...
async function startLogin() {
  ...
  try {
    ...
    const startResponse = await request('POST', '/start');
    ...
    console.log('[NOVA AUTH] Microsoft authentication started');
    console.log('[NOVA AUTH] Waiting for Microsoft login...');
    ...
    throw new Error('Microsoft authentication timed out');
  } catch (error) {
    console.error(
...
function cancelLogin() {
  console.log('[NOVA AUTH] Cancelling Microsoft login');
